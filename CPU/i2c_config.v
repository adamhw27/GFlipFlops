...
always @(*) begin
    case (lut_index)
        ...
        4'h2: lut_data <= 16'h0217; // right input
		  4'h3: lut_data <= 16'h0479; // left headphone output
		  4'h4: lut_data <= 16'h0679; // right headphone output
		  4'h5: lut_data <= 16'h08d4; // analog path control
		  4'h6: lut_data <= 16'h0a04; // digital path control - 44.1 Khz deenphasis control
		  4'h7: lut_data <= 16'h0e01; // digital interface format - 16 bits, MSB-First, left justified
        4'h8: lut_data <= 16'h1020; // sampling control - normal mode, 250 fs, 1000, 
