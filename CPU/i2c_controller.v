...
//			START Condition (Stage 0)
//
//			SDA transitions from HIGH to LOW while SCL is HIGH
//			Then SCL starts toggling
//
//			Data Transmission (Stages 1-8, 10-17, 19-26)
//
//			Each bit is set on SDA during midlow (SCL LOW)
//			The slave reads the bit when SCL goes HIGH
//			Data is sent MSB-first
//
//			ACK Reception (Stages 9, 18, 27)
//
//			Master releases SDA (sets to HIGH/Z)
//			Slave pulls SDA LOW to acknowledge
//			Master reads i2c_sdat to capture the ACK bit
//
//			STOP Condition (Stages 28-29)
//
//			Stage 28: SDA is LOW
//			Stage 29: SDA transitions LOW to HIGH while SCL is HIGH
